...
class AccountValidationIT {
    ...
    class OwnerNameValidation {
        ...
        void shouldReturn400_WhenOwnerNameIsNull() {
            // Arrange
            CreateAccountRequest request = AccountDataFactory.validAccount().withOwnerName(null).build();
        ...
        void shouldReturn400_WhenOwnerNameIsBlank() {
            CreateAccountRequest request = AccountDataFactory.validAccount().withOwnerName("").build();
        ...
        void shouldReturn400_WhenOwnerNameIsTooShort() {
            CreateAccountRequest request = AccountDataFactory.validAccount().withOwnerName("JL").build();
        ...
        void shouldCreateAccount_WhenOwnerNameHasMinLength() {
            CreateAccountRequest request = AccountDataFactory.validAccount().withOwnerName("Max").build();
        ...
        void shouldCreateAccount_WhenOwnerNameHasMaxLength() {
            ...
            CreateAccountRequest request = AccountDataFactory.validAccount().withOwnerName(ownerName).build();
    ...
    class EmailValidation  {
        ...
        void shouldReturn400_WhenEmailIsNull() {
            // Arrange
            CreateAccountRequest request = AccountDataFactory.validAccount().withEmail(null).build();
        ...
        void shouldReturn400_WhenEmailIsBlank() {
            CreateAccountRequest request = AccountDataFactory.validAccount().withEmail("").build();
        ...
        void shouldReturn400_WhenEmailContainsLeadingWhitespaces() {
            CreateAccountRequest request = AccountDataFactory.validAccount().withEmail("     @gmail.com").build();
        ...
        void shouldReturn400_WhenEmailIsInvalidFormated() {
            CreateAccountRequest request = AccountDataFactory.validAccount().withEmail("MCSWT").build();
        ...
        void shouldCreateAccount_WhenEmailHasMaxLength() {
            ...
            CreateAccountRequest request = AccountDataFactory.validAccount().withEmail(email).build();
    ...
    class BalanceValidation {
        ...
        void shouldReturn400_WhenInitialBalanceIsNull() {
            // Arrange
            CreateAccountRequest request = AccountDataFactory.validAccount().withBalance(null).build();
        ...
        void shouldReturn400_WhenInitialBalanceIsNegative() {
            CreateAccountRequest request = AccountDataFactory.validAccount().withBalance(new BigDecimal("-1")).build();
        ...
        void shouldReturn201_WhenInitialBalanceIsZero() {
            CreateAccountRequest request = AccountDataFactory.validAccount().withBalance(BigDecimal.ZERO).build();
        ...
        void shouldReturn201_WhenInitialBalanceHasMaximumAllowedPrecision() {
            CreateAccountRequest request = AccountDataFactory.validAccount().withBalance(new BigDecimal("12345678901234567.12")).build();
        ...
        void shouldReturn400_WhenInitialBalanceContainsMoreThan2FractionDigits() {
            CreateAccountRequest request = AccountDataFactory.validAccount().withBalance(new BigDecimal("100.123")).build();
        ...
        void shouldReturn400_WhenInitialBalanceContainsMoreThan17IntegerDigits() {
            CreateAccountRequest request = AccountDataFactory.validAccount().withBalance(new BigDecimal("123456789012345678.12")).build();
